...
Please email **lukewhitepsp@gmail.com** with a description of the issue and a
proof of concept if you have one. Do not open a public GitHub issue for
security-sensitive reports.

You should expect an acknowledgement within **72 hours** and a fix or
mitigation plan within **14 days** for issues affecting a supported version.
...
Only the latest minor on the latest major receives fixes. Drop-in upgrades
are made non-breaking when possible; see `CHANGELOG.md` for details.
